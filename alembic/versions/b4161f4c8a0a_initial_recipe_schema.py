...
def upgrade() -> None:
    ...
    sa.Column('ingredients_json', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('instructions_json', postgresql.JSON(astext_type=sa.Text()), nullable=True),
